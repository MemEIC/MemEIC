![MemEIC Logo](assets/image_1.png)
...
The CCKEB dataset is partially derived from the **VLKEB(24`NeurIPS)** dataset, which is licensed under the BSD 3-Clause License. All original copyright notices are preserved.
